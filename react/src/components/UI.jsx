export function Button({ 
  ...
  const baseStyles = `${displayStyle} items-center justify-center px-4 py-4 font-gill font-medium rounded-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed`;
  ...
  const variants = {
    ...
    dev: "bg-gray-400 text-white text-xs h-4 w-16 hover:bg-gray-500 shadow-none rounded-sm",
    submit: "bg-green-600 text-white hover:bg-green-700 focus:ring-green-600 justify-center bg-green-600 hover:bg-green-700 text-white",
