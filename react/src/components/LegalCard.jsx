...
const LegalCard = ({ className = "", defaultOpen = false }) => {
  const navigate = useNavigate();

  return (
    <CollapsibleCard title="Legal" defaultOpen={defaultOpen} className={className} padding={true} contentClassName="flex flex-col gap-3">
        <button
